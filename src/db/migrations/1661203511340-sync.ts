...
export class sync1661203511340 implements MigrationInterface {
    name = 'sync1661203511340'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "IDX_83bd32782d44d9db3d68c3f58c"
        `);
        await queryRunner.query(`
            DROP INDEX "IDX_31d658e0af554165f4598158c5"
        `);
        await queryRunner.query(`
